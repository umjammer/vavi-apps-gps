...
public class ShowTopology {
    ...
    public static void main(String[] argv) {
         ...
         */
System.out.println("Using UsbHub.getAttachedUsbDevices() to show topology:");
        processUsingGetAttachedUsbDevices(virtualRootUsbHub, "");

        /* Let's go through the topology again, but using getUsbPorts()
         * this time.
         */
System.out.println("Using UsbHub.getUsbPorts() to show topology:");
    ...
    public static void processUsingGetAttachedUsbDevices(UsbDevice usbDevice,
        ...
        for (int i = 0; i < attachedUsbDevices.size(); i++) {
            ...
            UsbDevice device = attachedUsbDevices.get(i);
    ...
    public static void processUsingGetUsbPorts(UsbDevice usbDevice,
        ...
        @SuppressWarnings("unchecked")
        List<UsbPort> usbPorts = usbHub.getUsbPorts();
